<script lang="ts">
    type IconName = 'crown' | 'edit' | 'async' | 'domainProcess' | 'sobjectBindings' | 'applicationFactory' | 'platformEvent';
...
{#if name === 'crown'}
    <svg viewBox="0 0 16 16" fill="currentColor">
        <path d="M1 5l3 2 4-4 4 4 3-2-1.5 8h-11L1 5zm2.5 9.5h9v1h-9v-1z" />
    </svg>
{:else if name === 'edit'}
